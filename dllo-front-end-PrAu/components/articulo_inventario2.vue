<template>
  <div>
    ...
    <EditarArticuloModal :value="mostrarModalEditar" :articulo="articuloParaEditar" @input="mostrarModalEditar = $event" />
  </div>
</template>

<script>
import { definePageMeta } from '#imports'
import EditarArticuloModal from "../components/editar_articulo.vue";
...
export default {
  ...
  setup() {
    const articulos = ref([]);
    const articuloParaEditar = ref(null);
    ...
    const EditarArticulo = (articulo) => {
      articuloParaEditar.value = { ...articulo }; // Clona el artículo para no modificarlo directamente
